...
*/
const botao = document.querySelector(".compreja_cartao_botao");

const plataformas = document.querySelector(".compreja_cartao_botao .compreja_cartao_botao_plataformas");
